# Transaction Control Demo (Oracle SQL)

This script demonstrates **COMMIT**, **ROLLBACK**, and **SAVEPOINT** in Oracle SQL.  
It works in **SQL\*Plus, SQLcl, and SQL Developer (Run Script mode)**.  
